...
tic;
% clear;
[thin1,Icc1]=tuxiangyuchuli('1-2.bmp');
% [thin2,Icc2]=tuxiangyuchuli('3_2.bmp');
figure;
txy1=point(thin1);
% txy2=point(thin2);
[w1,pxy1]=guanghua(thin1,txy1);
% [w2,pxy2]=guanghua(thin2,txy2);
thin1=w1;
% thin2=w2;
txy1=cut(Icc1,txy1);
% txy2=cut(Icc2,txy2);
[pxy31,error1]=single_point(txy1,10);
% [pxy32,error2]=single_point(txy2,15);
% disp(pxy31);
% [pxy32,error2]=single_point(txy2,15);
% [pxy31,error1]=combine(thin1,18,txy1,30);
% [pxy32,error2]=combine(thin2,15,txy2,30);
% error=1;
% num=20;
% cxy1=pxy31;
% cxy2=pxy32;
