...
extern "C"
{
	...
	ZKINTERFACE int APICALL ZKFingerVein_MergeFPEx(void* handle, unsigned char* tmp1, unsigned char* tmp2,unsigned char* tmp3, int count, unsigned char* regTmp, int* cbRegTmp);
	...
	ZKINTERFACE int APICALL ZKFingerVein_DBAddEx(void* dbHandle, int type, char* fvid, unsigned char* tmp1,unsigned char* tmp2, unsigned char* tmp3, int count);
